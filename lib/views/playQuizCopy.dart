...
class PlayQuizCopy extends StatefulWidget {
  final String quizId;
  final String uid;
  PlayQuizCopy({this.quizId, this.uid});
  @override
  _PlayQuizCopyState createState() => _PlayQuizCopyState();
}
...
class _PlayQuizCopyState extends State<PlayQuizCopy> {
